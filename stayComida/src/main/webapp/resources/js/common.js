$(document).ready(function(){
	...
	/*util.validation({
		validations :[
	 	 	{id:'search-file', requiredMsg : '검색값을 입력해주세요'}
	 	 ]
	});*/
});
...
/**
 * common Js
 * use URL : https://sweetalert2.github.io/#examples
 */
const common = {
...
const util = {
	 ...
	 */
	commonRetrieve : function(config){
		let resultObj = {};
		if(false){
			common.errorMsgAlert('paramter setting Please');
			return false;
		}
